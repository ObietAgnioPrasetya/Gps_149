            ...
            REQUEST_CODE -> {
                if (grantResults.size > 0) {
                    if (grantResults[0] == PackageManager.PERMISSION_GRANTED)
                        Toast.makeText(this@MainActivity, "Akses Diterima", Toast.LENGTH_SHORT)
                            .show()
                    else Toast.makeText(this@MainActivity, "Akses Ditolak", Toast.LENGTH_SHORT)
                        .show()
                }
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,android.Manifest.permission.ACCESS_FINE_LOCATION))
            ...
            button_stop.setOnClickListener(View.OnClickListener {
                ...
                button_start.isEnabled = !button_start.isEnabled
                button_stop.isEnabled = !button_stop.isEnabled
            })
        }
    }
